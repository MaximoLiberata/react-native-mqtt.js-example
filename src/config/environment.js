...
const envConfig = {
  ...
  MQTT_PORT: typeof process.env.EXPO_PUBLIC_MQTT_PORT === 'string' ? parseInt(process.env.EXPO_PUBLIC_MQTT_PORT) : 1883,
  MQTT_PORT_SSL: typeof process.env.EXPO_PUBLIC_MQTT_PORT_SSL === 'string' ? parseInt(process.env.EXPO_PUBLIC_MQTT_PORT_SSL) : 8883,
